...
import com.example.schoolteacher.parents.Settings.AppCompatPreferenceActivity;
import com.example.schoolteacher.R;

import java.util.List;

public class SettingsParentsActivity extends AppCompatPreferenceActivity {
    ...
    private void setupActionBar() {
        ...
        getLayoutInflater().inflate(R.layout.preference_list_content, (ViewGroup)findViewById(android.R.id.content));
    ...
    /**
     * This fragment shows student preferences only. It is used when the
    ...
    public static class StudentsPreferenceFragment
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            ...
            if (id == android.R.id.home) {
                startActivity(
                        new Intent(getActivity(), SettingsParentsActivity.class));
                return true;
            }
    ...
    /**
     * This fragment shows notifs preferences only. It is used when the
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
